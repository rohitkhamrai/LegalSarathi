  ...
  return (
    <div className="fixed inset-0 z-[60] pointer-events-none">
      <div
        ref={ref}
        style={{ top: topOffset }}
        className="pointer-events-auto absolute left-2 right-2 mx-auto max-w-md bg-card rounded-2xl shadow-card border border-border overflow-hidden animate-fade-in-up"
      >
