...
import { Toaster as Sonner } from "@desktop/components/ui/sonner";
import { Toaster } from "@desktop/components/ui/toaster";
import { TooltipProvider } from "@desktop/components/ui/tooltip";
import { LanguageProvider } from "@desktop/contexts/LanguageContext";
import { AuthProvider } from "@desktop/contexts/AuthContext";
import { GuestProvider } from "@desktop/contexts/GuestContext";
import { NotificationProvider } from "@desktop/contexts/NotificationContext";
import { PremiumProvider } from "@desktop/contexts/PremiumContext";
import { SOSProvider } from "@desktop/contexts/SOSContext";
import { CasesProvider } from "@desktop/contexts/CasesContext";
import { CommunityProvider } from "@desktop/contexts/CommunityContext";
import { PremiumUpgradeModal } from "@desktop/components/premium/PremiumUpgradeModal";
import { GuestLoginPrompt } from "@desktop/components/auth/GuestLoginPrompt";
import { SOSSheet } from "@desktop/components/sos/SOSSheet";
import { SOSFab } from "@desktop/components/sos/SOSFab";
import { ErrorBoundary } from "@desktop/components/common/ErrorBoundary";
import { ProtectedRoute } from "@desktop/components/common/ProtectedRoute";
